...
DEFAULT_ACTION_PROFILES: dict[str, list[str]] = {
    ...
    # Push = code lands on a shared remote: the merge profile plus secrets —
    # a hardcoded key leaks the moment it's pushed, even if never deployed.
    "push": ["secrets", "tests", "build", "preprod", "lockfile", "unfinished"],
}
